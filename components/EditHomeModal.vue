      ...
      <div class="is-hidden-touch">
        ...
        <b-tab-item label="NORMAL POWER GRID"> </b-tab-item>
          ...
          >
            ...
            >
              <template #header>
                <span class="has-text-white">WIP</span>
              </template>
              <div
                class="container"
                style="height: 60vh; overflow-x: hidden; overflow-y: scroll"
              >
                <h1 class="title is-4 has-text-white">WIP</h1>
                <!-- TABS -->
                <b-tabs
                  type="is-toggle"
                  class="block"
                        ...
                        >
                          <div class="columns" style="height: 23vh">
                            <div class="column">
                              ...
                              >
                                <b-carousel-item
                                  v-for="(img, i) in item[0].gallery.gallery"
                                  :key="i"
                                >
                                  <span class="image">
                                    <img :src="img.url" style="height: 20vh" />
                                  </span>
                                </b-carousel-item>
                                ...
                                <div style="overflow: auto">
                                  ...
                                  <div class="is-flex">
                                    <b-radio
                                      ...
                                      name="name"
                                      :native-value="option"
                                      class="is-flex is-align-items-center mr-2 has-text-white"
                                    >
                                      {{ option.catalogId }}
                                    </b-radio>
                                    <!-- <div
        ...
        <div class="footer-modal py-5">
          <div class="is-flex is-justify-content-space-between px-6 my-3">
            ...
            <h1 class="title is-2 has-text-white mb-0 mx-5">$510,250</h1> -->
              <b-button rounded class="mr-2" @click.prevent="saveHome"
                >SAVE HOME</b-button
              >
...
export default {
  ...
  mounted() {
    ...
    console.log(this.selectedAppliances, 'lkdaslkd')
  },
  methods: {
    getData() {
